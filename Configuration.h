...
#define STRING_CONFIG_H_AUTHOR "(Tige Kelley, X301 - SKR3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UTA EE Custom 3D Printer"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "cdef70b6-a008-400b-b455-93ee38896a0a"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 21.9, 2.5, -1.0 }
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR  //Use Filament Runout Sensor on TFT Display instead.
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  //#define FIL_RUNOUT_PIN  PC2              // E0DET pin on SKR V3
